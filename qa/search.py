...
def embedding_search(search_term, co, model="multilingual-22-12"):
  """Embed paragraphs and search for the closest ones to a query."""
  ...
  # ]
  response = co.embed(texts=[search_term], model=model)
  embeddings = response.embeddings[0]
  embeddings = [float(i) for i in embeddings]
  search_result = qdrant_client.search(collection_name="mycollection_xlarge",
